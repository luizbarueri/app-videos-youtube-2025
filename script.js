...
var flame = document.querySelector('iframe')

function abreVideo(x) {
    if  (x == 1) {
        flame.src = "https://www.youtube.com/embed/VG8ciFpwwcQ?list=RDVG8ciFpwwcQ"
    }
    if  (x == 2) {
    ...
    if  (x == 8) {
        flame.src = "https://www.youtube.com/embed/6NXnxTNIWkc?list=RDxhv4f6FjWNM"
    }
    if  (x == 9) {
